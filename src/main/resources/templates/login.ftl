...
<div class="customer-header">
    <div class="setout bit-ti-s po-re">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><a href="/"><img src="http://imgd.aotubuy.com${store_logo}" alt="logo"></a></td>
                <td class="pa-le-5"><img src="${StaticUrl}/images/split1.png" /></td>
                <td><span>凹凸果商城</span></td>
            </tr>
        </table>
    </div>
</div>
<div class="setout">
    <div class="login-area">
                    ...
                    <table class="pa-10-0" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="po-re">
                                ...
                                <img class="po-ab to0" id="verify_code_img" width="120" height="40" src="/verificationcode"  onclick="verify(this)" />
                                <a><img class="ma-le-142 po-ab to18" src="${StaticUrl}/images/chg_image.png" id="verify_code_img2"  onclick="verify(this)" /></a>
                            </td>
                        </tr>
                        <tr>
                            <td class="pa-to-30">
        ...
        <p class="nu-miaf">没有账号？&nbsp;&nbsp;<a href="/user/reg">免费注册</a></p>
...
<div class="cust-footer">
    <div class="setout po-re">
        <div class="warrant-area">
            <p>
                <a href="http://www.aotubuy.com/index.php/Home/Article/detail/article_id/1239.html">《凹凸果商城帐号服务条款、隐私政策》</a>
                <em>|</em>
                <a href="">常见问题？</a>
            </p>
...
<script>
    function verify(){
        $('#verify_code_img').attr('src','/verificationcode?r='+Math.random());
    }
    ...
    function checkSubmit()
    {
        ...
        $.ajax({
            type : 'post',
            url : '/user/doLogin?t='+Math.random(),
